  ...
  const handleRegister = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        "https://job-portal-backend-zj4k.onrender.com/api/v1/user/register",
      ...
      setPhone("");
      setRole("");
      setIsAuthorized(false); // Keep user as unauthorized
      navigate('/verify-otp'); // Navigate to login page after successful registration
    } catch (error) {
